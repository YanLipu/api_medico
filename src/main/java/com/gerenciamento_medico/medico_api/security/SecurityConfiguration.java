    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecutiry) throws Exception {
        return httpSecutiry
                ...
                .authorizeHttpRequests(authorize->authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/user/search").hasAuthority("NURSE")
                        .requestMatchers(HttpMethod.POST, "/api/v1/user").permitAll()
                        .requestMatchers("/v3/api-docs/**").permitAll()
                        .requestMatchers("/swagger-ui/**").permitAll()
                        .requestMatchers("/swagger-ui.html").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/v1/consultation/schedule").hasAuthority("PATIENT")
                        .requestMatchers(HttpMethod.PUT, "/api/v1/consultation/approve").permitAll()
